...
const guideFeatureDetailsEn = {
  rename: {
    ...
    details: [
      { title: 'Naming rule types', items: ['Sequence: define start value and digits (for example 001, 002, 003)', 'Text: insert any custom text content', 'Current time: multiple precision levels and separator formats', 'Created time: use file creation timestamp', 'Modified time: use file modification timestamp', 'File size: auto/B/KB/MB/GB/TB, optional unit display', 'Pixel size: width x height, width only, height only, aspect ratio, with configurable separators', 'Original name: keep all, find and replace, or crop by position', 'Separator: 15 common separators (such as -, _, ., (, ), [, ])', 'Random string: configurable length from 1 to 32, supports digits and letters'] },
