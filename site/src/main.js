...
const siteI18nEn = {
  ...
  featuresSubtitle: '8 practical tools for daily work',
  ...
  guideTitle: 'Guide',
  guideSubtitle: 'Quick start for 8 tools',
...
const siteI18n = {
  ...
  'zh-CN': {
    ...
    moreDownloads: '更多版本 →',
    featuresTitle: '功能特性',
    featuresSubtitle: '8 个实用工具，覆盖日常办公场景',
    techTitle: '技术栈',
    ...
    guideTitle: '使用手册',
    guideSubtitle: '按步骤阅读，快速上手 8 个工具',
    changelogTitle: '版本说明',
  ...
  'zh-TW': {
    ...
    featuresTitle: '功能特色',
    featuresSubtitle: '8 個實用工具，覆蓋日常辦公場景',
    techTitle: '技術棧',
    ...
    guideTitle: '使用手冊',
    guideSubtitle: '按步驟閱讀，快速上手 8 個工具',
    changelogTitle: '版本說明',
  ...
  'ja-JP': {
    ...
    featuresTitle: '機能',
    featuresSubtitle: '日常業務で使える 8 つのツール',
    techTitle: '技術スタック',
    ...
    guideTitle: 'ガイド',
    guideSubtitle: '8 つのツールをすぐに使い始める',
    changelogTitle: '更新履歴',
  ...
  'ko-KR': {
    ...
    featuresTitle: '기능',
    featuresSubtitle: '일상 업무를 위한 8 가지 도구',
    techTitle: '기술 스택',
  ...
  'fr-FR': {
    ...
    featuresSubtitle: '8 outils pratiques pour le quotidien',
    ...
    guideTitle: 'Guide',
    guideSubtitle: 'Prise en main rapide des 8 outils',
  ...
  'de-DE': {
    ...
    featuresSubtitle: '8 praktische Tools für den Alltag',
    ...
    guideSubtitle: 'Schnellstart für 8 Tools',
  ...
  'es-ES': {
    ...
    featuresSubtitle: '8 herramientas prácticas para el trabajo diario',
    ...
    guideTitle: 'Guía',
    guideSubtitle: 'Inicio rápido de 8 herramientas',
  ...
  'it-IT': {
    ...
    featuresSubtitle: '8 strumenti pratici per il lavoro quotidiano',
    ...
    guideTitle: 'Guida',
    guideSubtitle: 'Avvio rapido degli 8 strumenti',
  ...
  'ru-RU': {
    ...
    featuresSubtitle: '8 практичных инструментов для повседневной работы',
    ...
    guideSubtitle: 'Быстрый старт 8 инструментов',
...
const guideFeatureDetailsEn = {
  ...
  svg: {
    highlights: ['Three modes: merge, split, and browse SVG assets', 'Merge standalone SVG files into one reusable sprite', 'Split symbol-based SVG sprites into independent SVG files', 'Browse an SVG folder with search, preview, and source copy', 'All parsing, preview, and saving run locally'],
    snippet: {
      title: 'SVG workflow',
      lines: [
        { text: 'Merge: icons/*.svg -> sprite.svg', color: 'var(--color-syn-purple)' },
        { text: 'Split: all.svg symbol nodes -> independent SVG files', color: 'var(--color-syn-blue)' },
        { text: 'Browse: select folder, search icons, copy source', color: 'var(--color-syn-green)' },
        { text: '' },
        { text: 'Output folder is only required when saving', color: 'var(--color-syn-orange)' },
      ],
    },
    example: {
      type: 'before-after',
      title: 'Example: Prepare an icon library for a design system',
      before: { label: 'Input assets', items: ['Folder of standalone SVG icons', 'One SVG sprite with symbol nodes', 'Mixed icon files that need preview', 'Repeated or unsafe file names'] },
      after: { label: 'Organized result', items: ['Merged sprite.svg for shared use', 'Independent SVG files for each symbol', 'Searchable preview with source copy', 'Clean unique file names when saving'] },
    },
    details: [
      { title: 'Merge SVG', items: ['Select a folder that contains standalone SVG files', 'Preview and search icons before saving', 'Set the merged sprite file name', 'Save one SVG sprite with symbol nodes'] },
      { title: 'Split SVG', items: ['Select an SVG sprite that contains symbol nodes', 'Convert each symbol into an independent SVG file', 'Keep viewBox and common drawing attributes', 'Save all generated SVG files to an output folder'] },
      { title: 'Browse SVG', items: ['Select an SVG folder without choosing an output directory', 'Search by icon name and preview on a checkerboard background', 'Inspect file path, viewBox, text size, and SVG source', 'Copy SVG source text directly'] },
    ],
    workflow: ['Choose Merge, Split, or Browse mode', 'Select an SVG folder or SVG sprite file', 'Use search and tile size controls to inspect icons', 'Open detail view to check viewBox and source code', 'For merge or split, choose an output folder and save results'],
    tips: ['Use Browse mode when you only need to inspect an icon set.', 'Use Merge mode before shipping a shared sprite, and Split mode when you need individual assets.'],
  },
};
...
const features = [
  ...
  {
    id: 'svg', name: 'SVG 工具', icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="3"/><path d="M8.12 8.12 12 12"/><path d="M20 4 8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8 20 20"/></svg>', color: 'var(--color-syn-purple)',
    description: '面向图标资源整理的 SVG 工具，支持合并独立 SVG、拆分 symbol 精灵图，以及直接浏览 SVG 目录。',
    usp: '围绕 SVG 图标资产整理提供三种模式：把多个独立 SVG 合并为精灵图，把包含 symbol 的精灵图拆分为独立文件，或只选择一个 SVG 目录进行浏览、搜索和复制源码。所有解析、预览和保存都在本地完成，适合设计系统、前端图标库和素材归档场景。',
    highlights: ['三种模式：合并、拆分、浏览', '合并独立 SVG 为可复用精灵图', '拆分 symbol 精灵图为独立 SVG 文件', '浏览目录时支持搜索、预览和复制源码', '本地处理，不上传 SVG 内容'],
    snippet: { title: 'SVG 处理流程', lines: [
      { text: '合并：icons/*.svg → sprite.svg', color: 'var(--color-syn-purple)' },
      { text: '拆分：all.svg 中的 symbol → 独立 SVG 文件', color: 'var(--color-syn-blue)' },
      { text: '浏览：选择目录、搜索图标、复制源码', color: 'var(--color-syn-green)' },
      { text: '' },
      { text: '仅保存时需要选择输出目录', color: 'var(--color-syn-orange)' },
    ]},
    example: { type: 'before-after', title: '示例：整理设计系统图标库',
      before: { label: '输入资源', items: ['一批独立 SVG 图标文件', '一个包含 symbol 节点的 SVG 精灵图', '需要快速预览和搜索的图标目录', '可能包含重复或非法字符的文件名'] },
      after: { label: '整理结果', items: ['合并为统一的 sprite.svg', '按 symbol 拆出独立 SVG 文件', '在浏览模式中查看详情并复制源码', '保存时自动处理安全且唯一的文件名'] },
    },
    details: [
      { title: '合并 SVG', items: ['选择包含独立 SVG 文件的目录', '在保存前预览和搜索图标', '可设置合并后的精灵图文件名', '将多个 SVG 保存为一个包含 symbol 的精灵图'] },
      { title: '拆分 SVG', items: ['选择包含 symbol 节点的 SVG 精灵图', '将每个 symbol 转换为独立 SVG 文件', '保留 viewBox、fill、stroke 等常见绘制属性', '批量保存到指定输出目录，并处理重复文件名'] },
      { title: '浏览 SVG', items: ['选择 SVG 目录后即可浏览，无需选择输出目录', '支持按名称搜索，并在透明棋盘背景中预览', '可查看文件路径、viewBox、文本大小和 SVG 源码', '支持一键复制 SVG 源码文本'] },
    ],
    workflow: ['选择合并、拆分或浏览模式', '按模式选择 SVG 目录或 SVG 精灵图文件', '使用搜索和图标区域滑块检查预览效果', '点击图标查看 viewBox、路径和源码详情', '合并或拆分时选择输出目录并保存结果'],
  },
];
...
const guideTips = {
  ...
  svg: ['只需要查看图标集合时使用浏览模式，无需选择输出目录。', '发版前整理图标库可先合并为精灵图，需要独立资源时再使用拆分模式。'],
};
